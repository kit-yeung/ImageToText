...
function Home() {
        ...
        if (file) {
            ...
            try {
                ...
                if (data.extracted_text) {
                    ...
                    setLanguageOut(
                        ocrLangMap[data.detected_language] || "Unknown"
                    );
                    setUploaded(true);
                } else {
    ...
    const handleTranslate = async (e) => {
        ...
        try {
            ...
            const languageCode = Object.keys(translateLangMap).find(
                (key) => translateLangMap[key] === language
            );
            ...
            for (let i = 0; i < parts.length; i++) {
                ...
                if (
                    ...
                    languageIn !==
                        (translateLangMap[data.detected_language] || "Unknown")
                ) {
                    setLanguageIn(
                        translateLangMap[data.detected_language] || "Unknown"
                    );
