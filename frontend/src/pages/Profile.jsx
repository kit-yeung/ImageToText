...
const logout = async () => {
  ...
  return (
    <div className='user-container'>
        <div   className="w-41 h-41 justify-center items-center mb-4  rounded-full ring-4 ring-yellow-400 "><img className='w-24 h-24 p-3 ml-2' src={user}/> </div>
        <p>Name: 			<span className="yellow-border ml-5">
                <span className="font-semibold text-white text-[20px]">
                {capitalize(name)}
                  </span>
</span></p>
         <p>Email: 	<span className="yellow-border ml-5">
